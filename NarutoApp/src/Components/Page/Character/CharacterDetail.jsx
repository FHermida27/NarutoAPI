...
import ExpandMoreIcon from "@mui/icons-material/ExpandMore"; // Ícono de flecha
        ...
        <Box className="character-info">
          ...
          {showDetails && (
            <>
              ...
              <br />
              <Typography variant="body1"><strong>Familia:</strong> <font color="red">Padre : </font>{character.family.father}, <font color="red">Madre : </font>{character.family.mother}</Typography>
              <br />
              ...
              <br />
              <Typography variant="body1"><strong>Afiliacion:</strong> {character.personal.affiliation.join(" - ")}</Typography>
              <IconButton 
                color="secondary" 
